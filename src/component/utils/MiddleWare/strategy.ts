...
type ErrorRuleFunction = (value: any) => any;

/**
 * @des 策略模式
 */
class strategy {
    private errorRules: Record<string, ErrorRuleFunction>;
     ...
     * @param fn 方法
     */
    addRule(name: string, fn: ErrorRuleFunction): void {
     ...
     * @returns 
     */
    chainFn(rules: string[], value: string): strategyType {
        let result: strategyType = {
            code: 200,
            msg: [],
            status: true,
        };
